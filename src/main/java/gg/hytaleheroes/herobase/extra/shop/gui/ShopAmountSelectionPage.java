...
public class ShopAmountSelectionPage extends InteractiveCustomUIPage<ShopAmountSelectionPage.GuiData> {
    Element element;

    public ShopAmountSelectionPage(@Nonnull PlayerRef playerRef, Element element) {
